...
export class AppComponent {
  ...
  getUnitList(): void {
    ...
    this.obsUnit = this.http.get<Unit[]>('https://3000-c811a01d-79f2-424b-a16a-1c1bac3cd682.ws-eu01.gitpod.io/users');
...
addUnit(newUnit: HTMLInputElement, newCost: HTMLInputElement, newHitSpeed: HTMLInputElement, newDeployTime: HTMLInputElement,
   ...
   newType: HTMLInputElement, newRarity: HTMLInputElement): boolean {
    ...
    this.postObserver = this.http.post('https://3000-c811a01d-79f2-424b-a16a-1c1bac3cd682.ws-eu01.gitpod.io/users', JSON.stringify(newData),headers)
